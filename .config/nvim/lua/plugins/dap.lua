return {
  ...
  -- stylua: ignore
  keys = {
    { "<leader>dB", function() require("dap").set_breakpoint(vim.fn.input('Breakpoint condition: ')) end, desc = "Breakpoint Condition <S-F9>" },
    ...
    { "<S-F11>", function() require("dap").step_out() end, desc = "Step Out <S-F11>" },
    ...
    { "<S-F5>", function() require("dap").terminate() end, desc = "Terminate <S-F5>" },
